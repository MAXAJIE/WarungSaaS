...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Warung — Cozy ordering for stalls & kitchens" },
      {
        name: "description",
        content:
          "Warung runs your stall: counter orders, kitchen board, pickup handover and QR self-ordering in English, 中文 and Melayu.",
      },
      { name: "author", content: "Warung" },
